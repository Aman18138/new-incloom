...
const variants = {
  primary: "bg-primary text-primary-foreground hover:bg-primary-strong shadow-thread",
  secondary: "border border-border bg-card text-foreground hover:border-primary/45 hover:bg-elevated",
